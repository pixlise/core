...
// This is mighty unholy but reduces a whole deployment concern for 2 rarely/non-changing bits of Lua code. This is available if we're
// in a unit test, compiled into the API or running on a separate machine as part of the job runner!

var debugModule = `DebugHelp = {}

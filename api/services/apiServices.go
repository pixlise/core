...
type JobManagerInterface interface {
	...
	SubmitPythonJob(repoId, scriptName, scanId, quantId string, requestorUserSess *sessionuser.SessionUser, requestorSession *melody.Session) (*protos.JobStatus, error)

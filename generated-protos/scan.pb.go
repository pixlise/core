...
var file_scan_proto_rawDesc = []byte{
	...
	0x42, 0x4f, 0x41, 0x52, 0x44, 0x10, 0x03, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x3b, 0x70, 0x72, 0x6f,
...
var file_scan_proto_goTypes = []interface{}{
	...
	(*ScanItem)(nil),               // 2: ScanItem
	(*ScanMetaDataItem)(nil),       // 3: ScanMetaDataItem
	(*ScanEntryRange)(nil),         // 4: ScanEntryRange
	(*ScanItem_ScanTypeCount)(nil), // 5: ScanItem.ScanTypeCount
	nil,                            // 6: ScanItem.MetaEntry
	nil,                            // 7: ScanItem.ContentCountsEntry
}
var file_scan_proto_depIdxs = []int32{
	5, // 0: ScanItem.dataTypes:type_name -> ScanItem.ScanTypeCount
	1, // 1: ScanItem.instrument:type_name -> ScanInstrument
	6, // 2: ScanItem.meta:type_name -> ScanItem.MetaEntry
	7, // 3: ScanItem.contentCounts:type_name -> ScanItem.ContentCountsEntry

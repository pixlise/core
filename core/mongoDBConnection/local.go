...
func connectToLocalMongoDB(log logger.ILogger, mongoDebug bool) (*mongo.Client, MongoConnectionDetails, error) {
	cmdMonitor := makeMongoCommandMonitor(log, mongoDebug)

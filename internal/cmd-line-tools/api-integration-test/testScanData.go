...
func testScanDataNoPermission(apiHost string) {
	...
	u1.AddSendReqAction("pseudo (expect no permission)",
		...
		`{
			...
			"errorText": "View access denied for: SCAN (id: 048300551)",
			"pseudoIntensityResp": {}
		}`,
	)
	...
	u1.AddSendReqAction("imageGetReq (expect no permission)",
		...
		`{"msgId":9,
			"status": "WS_NO_PERMISSION",
			"errorText": "User cannot access scan 048300551 associated with image 048300551/PCW_0125_0678031992_000RCM_N00417120483005510091075J02.png. Error: View access denied for: SCAN (id: 048300551)",
			"imageGetResp":{}
		}`,
	)
	...
	u1.AddSendReqAction("scan meta write (not found)",
		...
		`{"msgId":11,
			"status": "WS_NO_PERMISSION",
			"errorText": "Edit access denied for: SCAN (id: 048300551)",
			"scanMetaWriteResp": {}
		}`,
	)

...
func testElementSets(apiHost string) {
	...
	u1CreatedElementSetId1 := wstestlib.GetIdCreated("u1CreatedElementSetId1") // Remember the ID that was created
	...
	u2.AddSendReqAction("Get created item for user 2",
		`{"elementSetGetReq": { "id": "${IDLOAD=u1CreatedElementSetId1}"}}`,
	...
	u2.AddSendReqAction("Get permissions for user 1's created item",
		`{"getOwnershipReq": { "objectId": "${IDLOAD=u1CreatedElementSetId1}", "objectType": 2 }}`,
	...
	u2.AddSendReqAction("Share user 1s created item",
		fmt.Sprintf(`{"objectEditAccessReq": { "objectId": "${IDLOAD=u1CreatedElementSetId1}", "objectType": 2, "addViewers": { "userIds": [ "%v" ] }}}`, u2.GetUserId()),
	...
	u1.AddSendReqAction("Get created item for user 1",
		`{"elementSetGetReq": { "id": "${IDLOAD=u1CreatedElementSetId1}"}}`,
		`{"msgId":7, "status":"WS_OK", "elementSetGetResp":{
			"elementSet": {
				"id": "${IDCHK=u1CreatedElementSetId1}",
				"name": "User1 ElementSet1",
				"lines": [
					{
						"Z":   14,
	...
	u1.AddSendReqAction("Edit created item with invalid request",
		`{"elementSetWriteReq": {
			"elementSet": {
				"id": "${IDLOAD=u1CreatedElementSetId1}",
	...
	u1.AddSendReqAction("Edit created item",
		...
		`{"msgId":9, "status":"WS_OK", "elementSetWriteResp":{
			"elementSet": {
				"id": "${IDCHK=u1CreatedElementSetId1}",
				"name": "User1 ElementSet1-Edited",
				"lines": [
	...
	u1.AddSendReqAction("Get edited item",
		`{"elementSetGetReq": { "id": "${IDLOAD=u1CreatedElementSetId1}"}}`,
		`{"msgId":10, "status":"WS_OK", "elementSetGetResp":{
			"elementSet": {
				"id": "${IDCHK=u1CreatedElementSetId1}",
				"name": "User1 ElementSet1-Edited",
				"lines": [
	...
	u1.AddSendReqAction("Get shared item",
		`{"elementSetGetReq": { "id": "${IDLOAD=u1CreatedElementSetId1}"}}`,
		`{"msgId":14, "status":"WS_OK", "elementSetGetResp":{
			"elementSet": {
				"id": "${IDCHK=u1CreatedElementSetId1}",
				"name": "User1 ElementSet1-Edited",
				"lines": [
	...
	u1.AddSendReqAction("Delete created item",
		`{"elementSetDeleteReq": { "id": "${IDLOAD=u1CreatedElementSetId1}" }}`,
